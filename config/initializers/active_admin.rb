ActiveAdmin.setup do |config|
  ...
  config.load_paths = [File.join(Rails.root,'app','admin'), File.join(Rails.root,'app','super_admin')]
  ...
  config.namespace :super_admin do |super_admin|
    ...
    super_admin.authentication_method = :authenticate_admin_user!
    super_admin.current_user_method = :current_admin_user
    super_admin.logout_link_path = :destroy_admin_user_session_path
  end
